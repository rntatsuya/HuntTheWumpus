...
public class Hunter extends Agent {
	...
	public Hunter(int x, int y, Vertex initRoom) {
		...
		win = false;
		try {               
			imageFacingRight = ImageIO.read(new File("hunterSamusRight.png"));
	    	imageFacingLeft = ImageIO.read(new File("hunterSamusLeft.png"));
	...
	public void player2() {
		try {               
			imageFacingRight = ImageIO.read(new File("hunterBlackRight.png"));
		    imageFacingLeft = ImageIO.read(new File("hunterBlackLeft.png"));	
    	}
		catch (IOException e) {
	      //Not handled.
    	}
